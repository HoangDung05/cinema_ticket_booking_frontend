    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-8 relative z-10">
        <div className="bg-surface-container-lowest rounded-2xl shadow-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 border border-outline-variant/20">
          <div className="flex gap-4 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-hide">
            <button className="px-6 py-2 bg-primary text-on-primary rounded-full font-headline font-bold whitespace-nowrap">Now Showing</button>
            <button className="px-6 py-2 bg-surface-container-low text-on-surface-variant hover:bg-surface-container-high rounded-full font-headline font-semibold transition-colors whitespace-nowrap">Coming Soon</button>
            <button className="px-6 py-2 bg-surface-container-low text-on-surface-variant hover:bg-surface-container-high rounded-full font-headline font-semibold transition-colors whitespace-nowrap">Exclusive</button>
          </div>
          <div className="flex items-center gap-4 w-full md:w-auto">
            <div className="relative flex-grow md:w-64">
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline">search</span>
              <input type="text" placeholder="Search movies..." className="w-full pl-10 pr-4 py-2 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary text-on-surface placeholder:text-outline" />
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="flex justify-between items-end mb-10">
          <div>
            <h2 className="text-3xl font-headline font-bold text-on-surface mb-2">Now Showing</h2>
            <p className="text-on-surface-variant">Experience the magic of cinema.</p>
          </div>
      ...
      <section className="bg-surface-container-low py-20 border-y border-outline-variant/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-3xl font-headline font-bold text-on-surface mb-2">Coming Soon</h2>
              <p className="text-on-surface-variant">Mark your calendars.</p>
            </div>
          </div>
